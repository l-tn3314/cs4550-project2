defmodule Project2.PostsTest do
  ...
  describe "posts" do
    ...
    test "create_post/1 with valid data creates a post" do
      ...
      assert post.time == DateTime.from_naive!(~N[2010-04-17T14:00:00Z], "Etc/UTC")
    end
    ...
    test "update_post/2 with valid data updates the post" do
      ...
      assert post.time == DateTime.from_naive!(~N[2011-05-18T15:01:01Z], "Etc/UTC")
    end
